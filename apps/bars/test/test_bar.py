...
class PublicBarTests(TestCase):
    ...
    def test_retrieve_bars(self):
        Bar.objects.create(name="TestBar1", owner=sample_owner("test@company.com", "1234"))
        Bar.objects.create(name="TestBar2", owner=sample_owner("competence@company.com", "1234"))
